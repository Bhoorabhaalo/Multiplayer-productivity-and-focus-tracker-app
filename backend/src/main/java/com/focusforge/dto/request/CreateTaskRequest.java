...
public class CreateTaskRequest {
    ...
    public CreateTaskRequest(String title, String note, Long podId, Task.Priority priority, LocalDateTime startAt, LocalDateTime deadlineAt, Integer pomodoroCycles) {
        this.title = title;
        this.note = note;
        this.podId = podId;
    ...
    public static class Builder {
        ...
        public CreateTaskRequest build() {
            CreateTaskRequest instance = new CreateTaskRequest();
